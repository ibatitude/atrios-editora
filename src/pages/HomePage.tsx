...
import { Book, Author, PageId } from '../types';
...
interface HomePageProps {
  ...
  onOpenAuthorModal: (author: Author) => void;
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-[#0F2C2C] hover:bg-[#1a4040] text-white font-bold text-xs uppercase tracking-wider rounded-sm shadow-md transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer group"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-4 bg-transparent hover:bg-[#0F2C2C05] text-[#0F2C2C] border border-[#0F2C2C30] hover:border-[#0F2C2C] font-bold text-xs uppercase tracking-wider rounded-sm transition-all duration-200 cursor-pointer"
                >
                  Conheça a Átrios
                </button>
              </div>
            ...
            <div className="lg:col-span-5 flex items-center justify-center relative">
              <div className="relative">
                ...
                <div className="relative bg-white border border-[#0F2C2C15] p-6 rounded-sm shadow-md max-w-sm">
                  ...
                  <div
                    onClick={() => onOpenBookModal(books[1])}
                  ...
                  <div className="mt-4 pt-3 border-t border-[#0F2C2C15] flex items-center justify-between">
                    ...
                    <button
                      onClick={() => onOpenBookModal(books[1])}
                      className="px-3.5 py-1.5 bg-[#0F2C2C] text-white text-xs font-bold uppercase tracking-wider rounded-sm hover:bg-[#1a4040] transition-colors cursor-pointer"
                    >
                      Ver Detalhes
                    </button>
                  </div>
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 text-sm font-bold text-[#0F2C2C] hover:opacity-80 transition-opacity cursor-pointer group"
              >
          ...
          <div className="lg:col-span-6">
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              {STATS.map((stat, idx) => (
                <div
                  key={idx}
                  className="bg-white p-6 rounded-sm border border-[#0F2C2C15] shadow-xs hover:border-[#0F2C2C]/30 transition-all text-center sm:text-left"
                >
                  <span className="font-serif font-bold text-3xl sm:text-4xl text-[#0F2C2C] block">
                    {stat.value}
                  </span>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[#0F2C2C15] pb-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-[#0F2C2C] hover:bg-[#1a4040] text-white text-xs font-bold uppercase tracking-wider rounded-sm transition-colors cursor-pointer"
            >
        ...
        <div className="flex flex-wrap items-center gap-2">
          {['Todas', 'Fé', 'Liderança', 'Família', 'Desenvolvimento Pessoal'].map((cat) => (
            <button
              key={cat}
              onClick={() => {
                if (cat !== 'Todas') onFilterCategory(cat);
                onNavigate('catalog');
                window.scrollTo({ top: 0, behavior: 'smooth' });
              }}
              className="px-3.5 py-1.5 text-xs font-bold rounded-sm bg-[#F5F1EB] hover:bg-[#E8E2D9] text-[#0F2C2C] transition-colors cursor-pointer"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {authors.map((author) => (
              <div
                ...
                className="bg-white rounded-sm p-6 border border-[#0F2C2C15] shadow-xs hover:shadow-md transition-all duration-300 text-center cursor-pointer group flex flex-col justify-between"
              >
                <div>
          ...
          <div className="text-center pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 border border-[#0F2C2C] text-[#0F2C2C] hover:bg-[#0F2C2C] hover:text-white font-bold text-xs uppercase tracking-wider rounded-sm transition-all cursor-pointer"
            >
      ...
      <section id="home-manuscript-cta" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#0F2C2C] text-[#FDFBF7] rounded-sm p-8 sm:p-12 border border-[#0F2C2C] shadow-lg flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <button
            ...
            className="px-8 py-4 bg-[#D9D1C5] hover:bg-[#E8E2D9] text-[#0F2C2C] font-bold text-xs uppercase tracking-widest rounded-sm shadow-md transition-all duration-200 flex-shrink-0 flex items-center gap-2 cursor-pointer"
          >
