...
import { EDITORIAL_VALUES } from '../data/mockData';
import {
  ShieldCheck,
  Feather,
  HeartHandshake,
      ...
      <section className="bg-[#0F2C2C] text-[#FDFBF7] p-8 sm:p-12 rounded-sm flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left shadow-md">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <button
            ...
            className="px-5 py-3 bg-[#D9D1C5] hover:bg-[#E8E2D9] text-[#0F2C2C] font-bold text-xs uppercase tracking-wider rounded-sm transition-colors cursor-pointer"
          >
            Explorar Catálogo
          </button>
          <button
            ...
            className="px-5 py-3 bg-transparent border border-[#FDFBF7]/40 hover:bg-white/10 text-[#FDFBF7] font-bold text-xs uppercase tracking-wider rounded-sm transition-colors cursor-pointer"
          >
            Submeter Original
          </button>
        </div>
